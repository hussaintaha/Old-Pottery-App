...
return [
    ...
    */
    ...
    'webhooks' => [
        [
          ...
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/app-uninstalled')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_levels/connect'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-level-connected')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_levels/disconnect'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-level-disconnected')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_levels/update'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-level-update')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_items/create'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-item-create')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_items/update'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-item-update')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'inventory_items/delete'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/inventory-item-delete')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'orders/create'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/order-created')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'products/create'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/product-created')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'products/update'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/product-updated')
        ],
        [
          'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'products/delete'),
          'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/product-deleted')
        ],
    ],
    ...
    */
    ...
    'scripttags' => [
            ...
            [
                'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://amkwebsolutions.com/shopify-app/taha_old_pottery/frontendscript'),
