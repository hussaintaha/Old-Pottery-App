<div class="row">
   <div class="column pending main-parent">
      ...
      <div class="cards location{{$pending->shopify_location_id}}">
         ...
         <div class="btn-opt">
            ...
            <button type="button" data-line="{{$pending->id}}"  style="display:none;" class="red-btn Acceptance">Accept</button>
         </div>
      ...
      <div class="border">
        @if(isset($orders['processing']))
         ...
         <div class="cards location{{$pending->shopify_location_id}}">
            ...
            <div class="btn-opt">
               <p class="text-right">{{ ($pending->shipping_type == 'custom') ? 'DELIVERY' : 'PICKUP' }}</p>
               <button type="button" data-line="{{$pending->id}}" style="display:none;" class="yellow-btn Ready">Ready</button>
            </div>
            <div class="show-hide text-center show-buttons">
              <a href="{{url('/pos-slip')}}?order_id={{$pending->id}}&shop={{$shop}}">
                 <i class="fa fa-print"></i>
   ...
   <div class="column ship">
      ...
      <div class="cards location{{$pending->shopify_location_id}}">
         ...
         <div class="btn-opt">
            <p class="text-right">{{ ($pending->shipping_type == 'custom') ? 'DELIVERY' : 'PICKUP' }}</p>
            <button data-line="{{$pending->id}}" style="display:none;" type="button" class="green-btn Shipped">Shipped</button>
         </div>
         <div class="show-hide text-center show-buttons">
           <a href="{{url('/pos-slip')}}?order_id={{$pending->id}}&shop={{$shop}}">
              <i class="fa fa-print"></i>
